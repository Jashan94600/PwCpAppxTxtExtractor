...
API_ID = int(os.environ.get("API_ID", 27463406))
API_HASH = os.environ.get("API_HASH", " 40229f3885b5bc03ba01a8fe78a9c073")
BOT_TOKEN = os.environ.get("BOT_TOKEN", "7535478624:AAF6tUXkJ3Zzzqh3vJyOem-spYV-8Ukn5dI")
